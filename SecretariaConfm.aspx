<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SecretariaConfm.aspx.cs" Inherits="AAP.SecretariaConfm" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>Secretaria</title>
     <link rel="stylesheet" type="text/css" href="SecretariaConfirm.css"/>
</head>
<body>
            ...
            <table style="width:100%;">
                <tr>
                    ...
                    <td style="margin-left: 40px">
                        <asp:CheckBox ID="CkbJan" runat="server" Text="Janeiro" CssClass="checkBox"  />
                        ...
                        <br />
                        <asp:CheckBox ID="Ckbabr" runat="server"  Text="Abril" CssClass="checkBox" />
                        &nbsp;&nbsp;&nbsp;
